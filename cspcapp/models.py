...
#     schhol_name_txt = models.CharField(max_length=50, blank=True, null=True)
...
class Contract(models.Model):
    ...
    student = models.ForeignKey('StudentPerson', models.DO_NOTHING)
    payer = models.ForeignKey('Person', models.DO_NOTHING)
    course_element = models.ForeignKey('CourseElement', models.DO_NOTHING, blank=True, null=True)
...
class PersonDocument(models.Model):
    ...
    valid_from_dt = models.DateField()
    addition_dttm = models.DateTimeField()
